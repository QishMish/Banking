...
export class AccountParamsTypeOrmRepository implements AccountParamsRepository {
  ...
  public find(
    findManyOptions: Partial<AccountParamsEntity>,
  ): Promise<[] | AccountParamsEntity[]> {
  ...
  findOne(
    findOptions: Partial<AccountParamsEntity>,
  ): Promise<AccountParamsEntity> {
    return this.accountParamsRepository.findOne({
      where: findOptions,
    });
  ...
  public async updateById(
    id: number,
    entity: Partial<AccountParamsEntity>,
  ): Promise<AccountParamsEntity> {
  ...
  public deleteById(id: number): Promise<boolean> {
    return this.accountParamsRepository
      .delete({ id })
