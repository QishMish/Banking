...
export class TransactionService {
  ...
  public find(options: FindTransactions): Promise<PaginationResult<TransactionModel>> {
    const { id, page = 1, pageSize = 15, status, type, userId, destinationAccId, sourceAccId } = options;
  ...
  public findOne(options: DeepPartial<TransactionModel>): Promise<TransactionModel | undefined> {
  ...
  public updateById(id: number, transaction: Partial<TransactionModel>): Promise<TransactionModel> {
